...
public enum WechatAPI {
    ...
    DATACUBE_GET_ARTICLE_READ(1, "%s/datacube/getuserread?access_token=%s", "获取图文统计数据-3d"),
    DATACUBE_GET_ARTICLE_READ_HOUR(1, "%s/datacube/getuserreadhour?access_token=%s", "获取图文统计分时数据-1d"),
    DATACUBE_GET_ARTICLE_SHARE(1, "%s/datacube/getusershare?access_token=%s", "获取图文分享转发数据-7d"),
    DATACUBE_GET_ARTICLE_SHARE_HOUR(1, "%s/datacube/getusersharehour?access_token=%s", "获取图文分享转发分时数据-1d"),
    DATACUBE_GET_ARTICLE_SUMMARY(1, "%s/datacube/getarticlesummary?access_token=%s", "获取图文群发每日数据-1d"),
    DATACUBE_GET_ARTICLE_TOTAL(1, "%s/datacube/getarticletotal?access_token=%s", "获取图文群发总数据-1d"),
    GET_INTERFACE_SUMMARY(1, "%s/datacube/getinterfacesummary?access_token=%s", "获取接口分析数据-30d"),
    DATACUBE_GET_USER_CUMULATE(1, "%s/datacube/getusercumulate?access_token=%s", "获取累计用户数据-7d"),
    DATACUBE_GET_USER_SUMMARY(1, "%s/datacube/getusersummary?access_token=%s", "获取用户增减数据-7d"),
    DATACUBE_GET_UPSTREAM_MSG(1, "%s/datacube/getupstreammsg?access_token=%s", "获取消息发送概况数据-7d"),
    DATACUBE_GET_UPSTREAM_MSG_DIST(1, "%s/datacube/getupstreammsgdist?access_token=%s", "获取消息发送分布数据-15d"),
    DATACUBE_GET_UPSTREAM_MSG_DIST_MONTH(1, "%s/datacube/getupstreammsgdistmonth?access_token=%s", "获取消息发送分布月数据-30d"),
    DATACUBE_GET_UPSTREAM_MSG_DIST_WEEK(1, "%s/datacube/getupstreammsgdistweek?access_token=%s", "获取消息发送分布周数据-30d"),
    DATACUBE_GET_UPSTREAM_MSG_HOUR(1, "%s/datacube/getupstreammsghour?access_token=%s", "获取消息分送分时数据-1d"),
    DATACUBE_GET_UPSTREAM_MSG_MONTH(1, "%s/datacube/getupstreammsgmonth?access_token=%s", "获取消息发送月数据-30d"),
    DATACUBE_GET_UPSTREAM_MSG_WEEK(1, "%s/datacube/getupstreammsgweek?access_token=%s", "获取消息发送周数据-30d"),
    ...
    MEDIA_UPLOAD(2, "%s/cgi-bin/media/upload?access_token=%s&type=%s", "上传图片"),
    MEDIA_UPLOAD_NEWS(2, "%s/cgi-bin/media/uploadnews?access_token=%s", "上传图文消息素材"),
