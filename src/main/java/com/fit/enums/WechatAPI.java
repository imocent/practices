...
public enum WechatAPI {
    ...
    ADD_MATERIAL(2,"%s/cgi-bin/material/add_material?access_token=%s&type=%s","新增其他类型永久素材"),
    ...
    CREATE_USER_TAG(1,"%s/cgi-bin/tags/create?access_token=%s","创建用户标签"),
    DELETE_MATERIAL(1,"%s/cgi-bin/material/del_material?access_token=%s","删除永久素材"),
    DELETE_USER_TAG(1,"%s/cgi-bin/tags/delete?access_token=%s","删除用户标签"),
    ...
    GET_BATCH_MATERIAL(1,"%s/cgi-bin/material/batchget_material?access_token=%s","获取批量素材"),
    ...
    GET_TICKET(1,"%s/cgi-bin/ticket/getticket?access_token=%s&type=%s",""),
