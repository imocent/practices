...
public class StringUtils {
    ...
    public static boolean isSpecialWhitespace(String text, int index) {
        ...
        int code = text.charAt(index);
        return code == CODE_NON_BREAKING_SPACE || (code >= CODE_EN_QUAD && code <= CODE_HAIR_SPACE) || code == CODE_NARROW_NO_BREAK_SPACE || code == CODE_MEDIUM_MATHEMATICAL_SPACE || code == CODE_IDEOGRAPHIC_SPACE;
    }
