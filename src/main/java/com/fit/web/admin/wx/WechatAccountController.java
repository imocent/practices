 ...
 */
@Controller
@RequestMapping("/admin/wx/account")
public class WechatAccountController {

    private static String PREFIX = "/admin/wx/account/";
    ...
    public AjaxResult list(HttpServletRequest request) {
        ...
        List<WxAccount> list = service.findList(map);
    ...
    public String editView(String id, Model model) {
        if (OftenUtil.isNotEmpty(id)) {
            WxAccount bean = service.getByObjId(id);
