...
import com.fit.entity.LmsQuestionWrong;
import com.fit.service.LmsQuestionAnswerService;
import com.fit.service.LmsQuestionWrongService;
...
public class QuestionWrongController extends BaseController {
    ...
    public Object list(HttpServletRequest request) {
        ...
        List<LmsQuestionWrong> list = this.service.findList(params);
    ...
    @PostMapping("/save")
    @ResponseBody
    public Object save(LmsQuestionWrong bean) {
        LmsQuestionWrong entity = this.service.get(bean.getId());
