...
layui.define(function (exports) {
    var face = {
        ...
        "[嘻嘻]": "layui-icon-face-smile-b",
        "[哈哈]": "layui-icon-face-smile",
        "[可爱]": "layui-icon-face-cry",
        "[可怜]": "layui-icon-face-cry",
        "[挖鼻]": "layui-icon-face-surprised",
        "[吃惊]": "layui-icon-face-surprised",
        "[害羞]": "layui-icon-face-smile",
        "[挤眼]": "layui-icon-face-smile-b",
        "[闭嘴]": "layui-icon-pause",
        "[鄙视]": "layui-icon-face-surprised",
        "[爱你]": "layui-icon-heart",
        "[泪]": "layui-icon-face-cry",
        "[偷笑]": "layui-icon-face-smile",
        "[亲亲]": "layui-icon-heart",
        "[生病]": "layui-icon-face-surprised",
        "[太开心]": "layui-icon-face-smile",
        "[白眼]": "layui-icon-face-surprised",
        "[右哼哼]": "layui-icon-reply-fill",
        "[左哼哼]": "layui-icon-reply-fill",
        "[嘘]": "layui-icon-pause",
        "[衰]": "layui-icon-face-surprised",
        "[委屈]": "layui-icon-face-cry",
        "[吐]": "layui-icon-face-surprised",
        "[哈欠]": "layui-icon-face-surprised",
        "[抱抱]": "layui-icon-heart",
        "[怒]": "layui-icon-face-surprised",
        "[疑问]": "layui-icon-help",
        "[馋嘴]": "layui-icon-face-surprised",
        "[拜拜]": "layui-icon-logout",
        "[思考]": "layui-icon-help",
        "[汗]": "layui-icon-face-surprised",
        "[困]": "layui-icon-face-surprised",
        "[睡]": "layui-icon-face-surprised",
        "[钱]": "layui-icon-rmb",
        "[失望]": "layui-icon-face-surprised",
        "[酷]": "layui-icon-face-smile",
        "[色]": "layui-icon-heart",
        "[哼]": "layui-icon-face-surprised",
        "[鼓掌]": "layui-icon-face-smile",
        "[晕]": "layui-icon-face-surprised",
        "[悲伤]": "layui-icon-face-cry",
        "[抓狂]": "layui-icon-face-surprised",
        "[黑线]": "layui-icon-face-surprised",
        "[阴险]": "layui-icon-face-smile",
        "[怒骂]": "layui-icon-face-surprised",
        "[互粉]": "layui-icon-heart-fill",
        "[心]": "layui-icon-heart",
        "[伤心]": "layui-icon-heart",
        "[猪头]": "layui-icon-face-surprised",
        "[熊猫]": "layui-icon-face-surprised",
        "[兔子]": "layui-icon-face-surprised",
        "[ok]": "layui-icon-ok",
        "[耶]": "layui-icon-face-smile",
        "[good]": "layui-icon-praise",
        "[NO]": "layui-icon-close",
        "[赞]": "layui-icon-praise",
        "[来]": "layui-icon-add-circle",
        "[弱]": "layui-icon-face-surprised",
        "[草泥马]": "layui-icon-face-surprised",
        "[神马]": "layui-icon-face-surprised",
        "[囧]": "layui-icon-face-surprised",
        "[浮云]": "layui-icon-cloud",
        "[给力]": "layui-icon-praise",
        "[围观]": "layui-icon-group",
        "[威武]": "layui-icon-face-smile",
        "[奥特曼]": "layui-icon-face-surprised",
        "[礼物]": "layui-icon-gift",
        "[钟]": "layui-icon-time",
        "[话筒]": "layui-icon-speaker",
        "[蜡烛]": "layui-icon-tips",
        "[蛋糕]": "layui-icon-trophy"
    };
